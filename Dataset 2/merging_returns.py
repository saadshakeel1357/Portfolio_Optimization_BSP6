...
gspc_df = pd.read_csv("STOXX50E_returns.csv", names=["Date", "STOXX50E"], header=None, skiprows=1, sep="\t")
ief_df = pd.read_csv("VGEA.DE_returns.csv", names=["Date", "VGEA.DE"], header=None, skiprows=1, sep="\t")
lqd_df = pd.read_csv("EUCO.L_returns.csv", names=["Date", "EUCO.L"], header=None, skiprows=1, sep="\t")
...
final_df = combined_df[["EUCO.L", "STOXX50E", "VGEA.DE"]]
